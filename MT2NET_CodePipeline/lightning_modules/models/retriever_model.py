...
class RetrieverModel(LightningModule):
    ...
    def __init__(self, 
        ...
        self.model = AutoModel.from_pretrained(self.transformer_model_name, force_download=True)
        self.warmup_steps = warmup_steps
        self.model_config = AutoConfig.from_pretrained(self.transformer_model_name, force_download=True)
